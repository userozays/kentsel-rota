...
import { AKTIVITE_TURU, BINA_DURUMU, SUREC_ADIMI } from "@/lib/sabitler";
import { goreceli, onayOzeti, sayi, tarih, tarihSaat, yuzde } from "@/lib/yardimcilar";
import { Avatar, BilgiSatiri, BosDurum, Rozet, Uyari } from "@/components/ortak";
import { BelgelerKarti, type BelgeSatiri } from "@/components/belgeler-karti";
import { AktiviteFormu } from "../binalar/[id]/etkilesim";
import type { MuteahhitDetayi } from "./muteahhit-verisi";

/**
 * Müteahhit detayının gövdesi — hem tam sayfa hem profil modalı bunu kullanır.
 * Tek kaynak: iki kopya tutulsaydı biri güncellenip diğeri unutulurdu.
 */
export function MuteahhitGovdesi({
  muteahhit,
  belgeler,
  duzenlenebilir,
}: {
  muteahhit: MuteahhitDetayi;
