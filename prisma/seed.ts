...
async function main() {
  ...
  const kullaniciTanimlari = [
    { ad: "Kerem Demir", email: "admin@kentselrota.com", rol: "ADMIN", telefon: "0532 000 00 01" },
    { ad: "Selin Aydın", email: "selin@kentselrota.com", rol: "DANISMAN", telefon: "0532 000 00 02" },
    { ad: "Barış Korkmaz", email: "baris@kentselrota.com", rol: "DANISMAN", telefon: "0532 000 00 03" },
    { ad: "Merve Tekin", email: "merve@kentselrota.com", rol: "DANISMAN", telefon: "0532 000 00 04" },
    { ad: "Cemal Bulut", email: "cemal@kentselrota.com", rol: "IZLEYICI", telefon: "0532 000 00 05" },
  ];
  ...
  console.log("  E-posta : admin@kentselrota.com");
